                    ...
                    <div class = "col-lg-12 col-md-12 col-sm-12" style = "margin-top:10px">
                        <div class = "form-group">
                            ...
                            <div class="col-lg-2 btn-group pull-right col-lg-push-1">
                                ...
                                {/if}
                                {if $NAVIGATION}
                                    <button class="btn btn-default btn-lg" id="quickPreviewPreviousRecordButton" data-id = '{$PREVIOUS_RECORD_ID}' {if empty($PREVIOUS_RECORD_ID)} disabled="disabled"{else} onclick="return false"{/if} >
                                        <i class="fa fa-chevron-left"></i>
                                    </button>
                                    <button class="btn btn-default btn-lg" id="quickPreviewNextRecordButton" data-id = '{$NEXT_RECORD_ID}' {if empty($NEXT_RECORD_ID)} disabled="disabled"{else} onclick="return false"{/if}>
